...
<h1><img src="images/logo-dcic.png"> HTML5 Slide Template</h1>
...
launch a simple one and point your default browser to [`http://localhost:8000/`](http://localhost:8000/):
...
To enable presenter mode, add `presentme=true` to the URL: [http://localhost:8000/?presentme=true](http://localhost:8000/?presentme=true)

To disable presenter mode, hit [http://localhost:8000/?presentme=false](http://localhost:8000/?presentme=false)
